...
<body>
<script type="text/javascript" src="../../resources/js/agileboard.commons.js" defer></script>
<script type="text/javascript" src="../../resources/js/agileboard.users.js" defer></script>
    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${users}" var="user">
                <jsp:useBean id="user" type="ua.com.agileboard.model.User"/>
